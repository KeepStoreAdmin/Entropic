 ...
 <h1>Scheda Prodotto</h1>
    ...
    <asp:FormView ID="fvPage" runat="server" DataKeyNames="id" DataSourceID="sdsArticolo" Width="100%" Height="1px">
          <ItemTemplate>
                        ...
                        <p align="center">
                            <div id="contenuto_popup" style="overflow:auto; height:auto; width:auto;">
                                ...
                                <div id="dettagli_arrivi_lightbox" style="width:500px; height:100%; overflow:auto; background-color:White; margin:auto;">
                                    <asp:SqlDataSource ID="SqlData_Arrivo" runat="server" ConnectionString="<%$ ConnectionStrings:EntropicConnectionString %>" ProviderName="<%$ ConnectionStrings:EntropicConnectionString.ProviderName %>"
            ...
            <br />
            <asp:HyperLink ID="HyperLink1" runat="server" ToolTip="Visualizza tutta la categoria" Font-Size="8pt" NavigateUrl='<%# "articoli.aspx?st="& Eval("SettoriId") &"&ct="& Eval("CategorieID") &"&mr="& Eval("MarcheId") &"&tp="& Eval("TipologieID") &"&gr="& Eval("GruppiID") &"&sg="& Eval("SottogruppiID") %>' Text='<%# Eval("SettoriDescrizione") & " <font color=#E12825><b>»</b></font> " & Eval("CategorieDescrizione") & " <font color=#E12825><b>»</b></font> "& Eval("MarcheDescrizione") &" <font color=#E12825><b>»</b></font> "& Eval("TipologieDescrizione") &" <font color=#E12825><b>»</b></font> "& Eval("GruppiDescrizione") &" <font color=#E12825><b>»</b></font> "& Eval("SottogruppiDescrizione") %>'></asp:HyperLink>
            <br /><br />
            <span class="link">
            
            <!-- Articolo Nuovo -->
            <div style="width:100%; height:auto;" class="bg-white">
            
            <!-- Descrizione Prodotto -->
            <table style="width:99%; height:100%;">
                <tr>
                    <td colspan="2" style="height:50px; border-bottom-style:solid; border-color:Gray; border-width:1px;">
                        <!-- Titolo ARTICOLO -->
                        <div style="padding:5px; width:100%; padding-bottom:10px; padding-top:10px;">
						...
						<div class="row">
							<div class="col-12 col-md-5">
								...
								<div style="margin-top:0px; width:100%; margin-left:5px; position:relative;"> 
									...
									<div id="main_view" style="text-align:center; float:right; width:100%; margin: 4rem 0;">
													...
													<a href="#" target="_self"><img id="main_img" style="max-height: 100%; max-width: 100%;" src="<%# checkImg(Eval("Img1")) %>" alt="" onclick="nascondi_dettagli_lightbox();" /></a>
									...
									<div class="thumb" style="width:100%; margin:auto;"> 
										...
										<script runat="server">
											...
											Function controllo_img(ByVal temp As String) As String
											...
											<%#IIf(Eval("Img2") <> "", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img2")) & "'><img src='" & checkImg(Eval("Img2")) & "' style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img1")) & "'><img src=" & checkImg(Eval("Img1")) & " style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>")%>
											<%#IIf(Eval("Img3") <> "", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img3")) & "'><img src='" & checkImg(Eval("Img3")) & "' style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img1")) & "'><img src=" & checkImg(Eval("Img1")) & " style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>")%>
											<%#IIf(Eval("Img4") <> "", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img4")) & "'><img src='" & checkImg(Eval("Img4")) & "' style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img1")) & "'><img src=" & checkImg(Eval("Img1")) & " style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>")%>
											<%#IIf(Eval("Img5") <> "", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img5")) & "'><img src='" & checkImg(Eval("Img5")) & "' style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img1")) & "'><img src=" & checkImg(Eval("Img1")) & " style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>")%>
											<%#IIf(Eval("Img6") <> "", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img6")) & "'><img src='" & checkImg(Eval("Img6")) & "' style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>", "<li style='float:left; padding:3px;'><table style='width:70px; height:80px; text-align:center; vertical-align:middle;'><tr><td><a href='" & checkImg(Eval("Img1")) & "'><img src=" & checkImg(Eval("Img1")) & " style='width:40px; max-height:80px;' alt='' /></a></td></tr></table></li>")%>
										</ul> 
									</div>          
								</div>
							</div>
							...
							<div class="col-12 col-md-7">
								<div style="width:100%; overflow:hidden;">
									<!-- Marca -->
									<li style="list-style:none; text-align:center;"><img style="height:50px; max-width:300px;" alt='<%# Eval("MarcheDescrizione") %>' src='<%# Eval("Marche_img", "Public/Marche/{0}") %>' visible='<%# controllo_img(Eval("Marche_img")) %>' /></li>
									
									<!-- Icone Operazioni -->
									<div style="width:100%; height:40px; text-align:center;/* padding-top:20px;*/ padding-bottom:20px;">
											...
											<td style="vertical-align:top;">
												<table>
													<tr>
														...
														<td>
															<asp:Label ID="Label22" runat="server" Text='<%# Bind("codice") %>'></asp:Label>       
														</td>
													</tr>
													<tr>
														<td>
														...
														<td>
															<asp:Label ID="Label21" runat="server" Text='<%# Bind("ean") %>'></asp:Label>
														</td>
													</tr>
													<tr>
														<td>
														...
														<td>
															<asp:Label ID="Label2" runat="server" Text='<%# Bind("Visite") %>'></asp:Label>
														</td>
													</tr>
												</table>
											</td>
											<td style="vertical-align:top;padding-left: 2rem;">
												...
												<table>
													...
													<tr>
														...
														<td>
															<!-- <a href="#" target="_self"><img id="dettagli_arrivi" src="Public/Images/Info.png" style="width:15px; padding-left:10px;" alt="" onclick="nascondi_immagine_lightbox_PIPPO();" /></a> -->
																...
																<table style="width:98%; background-color:#ededed; vertical-align:middle;">
																	<tr style=" padding-right:2%;">
																		...
																		<td style="padding:3px; text-align:right;">
																			<asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Size="8pt" Text='<%# Eval("Descrizione") %>'></asp:Label> <b style="color:Red;"><asp:Label ID="Label7" runat="server" Font-Names="Arial" Font-Size="8pt" Text='<%# iif(controlla_iva_spedizione()=2,String.Format("{0:c}", Eval("CostoFisso")*((Session("Iva_Vettori")/100)+1)),String.Format("{0:c}", (Eval("CostoFisso")))) %>'></asp:Label></b>        
																		</td>
																	</tr>
																</table>
															</div>
									...
									<table style="width:100%; text-align:right;">
										...
										<tr>
											<td colspan="2">
												<asp:Label ID="lblPrezzoPromo" runat="server" Font-Bold="True" Font-Size="12pt" ForeColor="#E12825" Text='<%# Bind("Prezzo","{0:C}") %>' Visible="False" style="text-align:right"></asp:Label><asp:Label ID="lblPrezzoIvato" CssClass="colore_sito" runat="server" Text='<%# Bind("PrezzoIvato","{0:C}") %>' Font-Bold="True" Font-Size="22pt" style="text-align:right" Visible="False"></asp:Label><asp:Label ID="lblPrezzo" CssClass="colore_sito" runat="server" Font-Bold="True" Font-Size="22pt" Text='<%# Bind("Prezzo","{0:C}") %>' Visible="False" style="text-align:right"></asp:Label><asp:Label ID="lblID" runat="server" Text='<%# Bind("ID") %>' Visible="false"></asp:Label></b>
												<br />
												...
												<script runat="server">
													Function controlla_abilitazione_iva_rc(ByVal utente_abilitato_reverse_charge As Integer, ByVal idIvaRC_articolo As Integer) As String
														If (utente_abilitato_reverse_charge = 1) And (idIvaRC_articolo <> -1) Then
															Return ""
														Else
															Return "none"
														End If
           ...
           <div class="bg-white" style="width:100%; padding-top:0px; overflow:auto; height:auto; color:White; font-weight:bold; font-size:8pt; border-bottom-style:solid; border-bottom-width:2px; border-color:Gray;">
                <div id="infobar" style="text-align:left; float:left; width:148px; height:33px; background-image:url('Images/tab.png'); background-repeat:no-repeat; background-position:top left; z-index:1;">
                    <div style="margin-left:28px; margin-top:12px; overflow:auto;"><asp:LinkButton ID="LB_Dettagli" ForeColor="white" runat="server" OnClick="LB_Dettagli_Click" CausesValidation="False">DETTAGLI</asp:LinkButton></div>
                </div>
                <div id="infobar" style="text-align:left; float:left; width:148px; height:33px; background-image:url('Images/tab.png'); background-repeat:no-repeat; background-position:top left; z-index:2; margin-left:-25px;">
                    <div style="margin-left:13px; margin-top:12px; overflow:auto;"><asp:LinkButton ID="LB_ArtCollegati" ForeColor="white" runat="server" OnClick="LB_ArtCollegati_Click" CausesValidation="False">ART. CORRELATI</asp:LinkButton></div>
                </div>
                <div id="infobar" style="text-align:left; float:left; width:148px; height:33px; background-image:url('Images/tab.png'); background-repeat:no-repeat; background-position:top left; z-index:2; margin-left:-25px;">
                    <div style="margin-left:25px; margin-top:12px; overflow:auto;"><asp:LinkButton ID="LB_Recensioni" ForeColor="white" runat="server" OnClick="LB_Recensioni_Click" CausesValidation="False">IN PROMO</asp:LinkButton></div>
                </div>
				<div id="infobar" style="text-align:left; float:left; width:148px; height:33px; background-image:url('Images/tab.png'); background-repeat:no-repeat; background-position:top left; z-index:2; margin-left:-25px;">
                    <div style="margin-left:25px; margin-top:12px; overflow:auto;"><asp:LinkButton ID="LB_NormeGaranzia" ForeColor="white" runat="server" OnClick="LB_NormeGaranzia_Click" CausesValidation="False">GARANZIA</asp:LinkButton></div>
                </div>
           </div>
