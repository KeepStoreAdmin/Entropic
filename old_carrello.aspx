...
<br />
    ...
    <table style="width:100%; font-size:8pt; text-align:center; font-weight:bold; background-color:rgb(244, 244, 244);">
        <tr>
            ...
            <td style="width:38%;">
                <table style="width:100%;">
                    <tr>
                        <td style="width:35%;">Prezzo<br/>Unitario</td>
                        <td>Q.tà</td>
                        <td style="width:35%; text-align:right;">Prezzo<br/>Totale</td>
                    </tr>                
                </table>
            </td>
        </tr>
    ...
    <asp:GridView ID="gvArticoliGratis" runat="server"
        AutoGenerateColumns="False" CellPadding="2" DataKeyNames="id" DataSourceID="sdsArticoli_Spedizione_Gratis"
        Font-Size="8pt" GridLines="None" Width="100%" EmptyDataText="" ShowHeader="false">
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <table style="width:100%; height:80px; border-style:dotted; border-bottom-style:none; border-color:Gray; border-width:1px;">
                        <tr>
                            <td style="width:80px;">
                                <!-- Immagine -->
                                <div style="width:80px; height:80px; overflow:hidden; text-align:center; overflow:hidden;">
                                    <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# "~/articolo.aspx?id="& Eval("articoliid") %>' ><asp:Image ID="Image2" runat="server" style="height:100%; margin:auto;"  AlternateText='<%# Eval("Descrizione1") %>' ImageUrl='<%# Eval("img1", "~/Public/foto/_{0}") %>' /></asp:HyperLink>
                                </div>
                            </td>
                            <td>
                                <table style="width:100%; height:100%; border-collapse:collapse;">
                                    <tr>
                                        <td style="font-size:10pt; vertical-align:top;">
                                            ...
                                            <asp:Label ID="lblIvaReverseCharge" runat="server" Text='<%# stampa_iva_applicata(Eval("DescrizioneEsenzioneIva"),Eval("DescrizioneIvaRC")) %>' Visible="true" Font-Size="7pt"></asp:Label>
                            ...
                            <td style="width:38%; text-align:right; vertical-align:middle; font-weight:bold; font-size:12pt;">
                                <table style=" width:100%; height:100%; vertical-align:top; text-align:center; font-family:Arial;">
                                    <tr>
                                        <td style="width:35%; position:relative; font-weight:bold; vertical-align:top;">
                                        ...
                                        <td style="position:relative; font-size:10pt; vertical-align:top; padding-left:10px; padding-right:10px; border-right-style:solid; border-left-style:solid; border-color:#f0f0f0; border-width:1px;">
                                            <asp:TextBox ID="tbQta"  runat="server" Text='<%# Eval("qnt") %>' style="width:50px; font-size:11pt; font-weight:bold; border-style:none; text-align:center; border-style:none; background-color:rgb(244, 244, 244);" MaxLength="4"/>
                                            <asp:LinkButton ID="LB_Aggiorna" CommandName="Aggiorna" runat="server" PostBackUrl="carrello.aspx" style="margin:auto; font-size:7pt; color:Gray;">Aggiorna</asp:LinkButton>
                                            <div style="padding-top:5px;">
                                                <asp:LinkButton ID="LB_Delete" CommandName="Elimina" CommandArgument='<%# Eval("id") %>' runat="server" PostBackUrl="carrello.aspx" style="margin:auto; font-size:7pt; color:rgb(205, 38, 44);">Elimina</asp:LinkButton>
                                            </div>
                                            
                                            
                                            <asp:TextBox ID="tbID"  runat="server" Text='<%# Eval("id") %>' Visible="false"/>
                                        </td>
                                        <td style="width:35%; position:relative; font-weight:bold; vertical-align:top; text-align:right; color:rgb(205, 38, 44);">
    ...
    <asp:GridView ID="GridView1" runat="server"
        AutoGenerateColumns="False" CellPadding="2" DataKeyNames="id" DataSourceID="sdsArticoli"
        Font-Size="8pt" GridLines="None" Width="100%" EmptyDataText="" ShowHeader="false">
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataBuonoSconto" runat="server" ConnectionString="<%$ ConnectionStrings:EntropicConnectionString %>"
        EnableViewState="False" ProviderName="<%$ ConnectionStrings:EntropicConnectionString.ProviderName %>"
        SelectCommand="SELECT * FROM buoni_sconti WHERE idBuonoSconto=@idBuonoSconto">
        <SelectParameters>
    ...
    <asp:GridView ID="GV_BuoniSconti" DataSourceID="SqlDataBuonoSconto" runat="server" AutoGenerateColumns="False" GridLines="None" BorderStyle="None" CellSpacing="0" ShowHeader="False" Width="100%">
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:Label ID="lbl_idBuonoSconto" runat="server" Text='<%# Eval("idBuonoSconto")%>' Visible="false"></asp:Label>
                    ...
                    <asp:Label ID="lbl_OperatoreLogico" runat="server" Text='<%# Eval("operatoreLogico")%>' Visible="false"></asp:Label>
...
<br /><br /><asp:Label ID="lblPrezzi" runat="server" Text="*Prezzi" Font-Size="7pt" Font-Names="arial"></asp:Label>

    <asp:Panel ID="Panel_BuoniSconto" runat="server" Width="70%" HorizontalAlign="left" style="padding:5px; border-style:dotted; border-width:1px; border-radius:10px; text-align:center; overflow:hidden; background-color:rgb(255, 252, 224);" >
            <br /><br />
            <div style="padding-bottom:10px; font-size:11px; text-align:center;">
                Se disponi di un <b>CODICE PROMOZIONALE</b>, digitalo qui
            </div>
            <div style="width:100%; overflow:auto; text-align:left; font-size:20px;">
                <table style=" width:100%; vertical-align:middle;">
                    <tr>
                        <td style="position:relative;">
                            <asp:TextBox ID="TB_BuonoSconto" runat="server" style="height:20px; font-size:20px; font-weight:bold; width:98%; text-transform:uppercase; padding:1%; padding-left:1%;"></asp:TextBox>            
                        ...
                        <td style="width:1%;">
                            <asp:Button ID="BT_ApplicaBuonoSconto" runat="server" Text="Applica" Height="100%"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
...
<asp:TextBox ID="tbVettoriId" runat="server" ToolTip="VettoriId" style="display:none" Width="20px"></asp:TextBox><asp:TextBox ID="tbPagamenti" runat="server" ToolTip="PagamentiId" style="display:none" Width="20px"></asp:TextBox><asp:TextBox ID="tbContrPerc" runat="server" ToolTip="Contrassegno Percentuale" style="display:none" Width="20px"></asp:TextBox><asp:TextBox ID="tbContrFisso" runat="server" ToolTip="Contrassegno Fisso" style="display:none" Width="20px"></asp:TextBox><asp:TextBox ID="tbContrMinimo" runat="server" ToolTip="Contrassegno Minimo" style="display:none" Width="20px"></asp:TextBox><asp:TextBox ID="tbPeso" runat="server" Width="20px" style="display:none" ToolTip="Peso"></asp:TextBox><asp:TextBox ID="tbTotale" runat="server" Width="20px" style="display:none" ToolTip="Totale"></asp:TextBox> 

</td><td align="right" width="30%" valign="top" style="line-height: 135%;font-size:8pt;">
<table width="100%" id="TableConteggi" runat="server" visible="false">
<tr>
<td align="right" valign="top" style="line-height: 135%;font-size:8pt; width: 57%;">
    Imponibile:</td>
<td align="right" width="50%" valign="top" style="font-size:9pt"><asp:Label ID="lblImponibile" runat="server" Text="&#8364; 0,00" Font-Bold="true"></asp:Label></td>
</tr>
<tr>
<td align="right" valign="top" style="line-height: 135%;font-size:8pt; width: 57%;">
    Spedizione:</td>
<td align="right" width="50%" valign="top" style="font-size:9pt"><asp:Label ID="lblSpeseSped" runat="server" Text="&#8364; 0,00" Font-Bold="true"></asp:Label></td>
</tr>
<tr>
<td align="right" valign="top" style="line-height: 135%;font-size:8pt; width: 57%;">
    Assicurazione:</td>
<td align="right" width="50%" valign="top" style="font-size:9pt"><asp:Label ID="lblSpeseAss" runat="server" Text="&#8364; 0,00" Font-Bold="true"></asp:Label></td>
</tr>
<tr>
<td align="right" valign="top" style="line-height: 135%;font-size:8pt; width: 57%;">
    Pagamento:</td>
<td align="right" width="50%" valign="top" style="font-size:9pt"><asp:Label ID="lblPagamento" runat="server" Text="&#8364; 0,00" Font-Bold="true"></asp:Label></td>
</tr>
<tr>
<td align="right" valign="top" style="line-height: 135%;font-size:8pt; width: 57%;">
    IVA:</td>
<td align="right" width="50%" valign="top" style="font-size:9pt"><asp:Label ID="lblIva" runat="server" Text="&#8364; 0,00" Font-Bold="true"></asp:Label></td>
</tr>
<tr>
<td align="right" valign="top" style="line-height: 135%;font-size:8pt; width: 57%;">
    Buono Sconto:</td>
<td align="right" width="50%" valign="top" style="font-size:9pt"><asp:Label ID="lblBuonoSconto" runat="server" Text="&#8364; 0,00" Font-Bold="true"></asp:Label></td>
</tr>
<tr>
<td align="right" valign="top" style="line-height: 135%;font-size:8pt; width: 57%;"><b>
    Totale:</b></td>
<td align="right" width="50%" valign="top" style="font-size:9pt"><asp:Label ID="lblTotale" runat="server" Text="&#8364; 0,00" Font-Bold="true" style="color:rgb(205, 38, 44);"></asp:Label></td>
</tr>
</table>
</tr>
<tr>
        ...
        <table style="width:100%; vertical-align:center;">
            <tr>
                <td style="width:20%; text-align:center;">
                    <asp:LinkButton ID="btContinua" runat="server" ForeColor="White"><div id="infobar" style="padding:5px; color:White; font-weight:bold; font-size:8pt;">Continua</div></asp:LinkButton>
                </td>
                
                <td style="width:20%; text-align:center;">
                    <asp:LinkButton ID="btAggiorna" runat="server" ForeColor="White"><div id="infobar" style="padding:5px; color:White; font-weight:bold; font-size:8pt;">Aggiorna Carrello</div></asp:LinkButton>
                </td>
                
                <td style="width:20%; text-align:center;">
                    <asp:LinkButton ID="btSvuota" runat="server" ForeColor="White"><div id="infobar" style="padding:5px; color:White; font-weight:bold; font-size:8pt;">Svuota Carrello</div></asp:LinkButton>
                </td>
                
                <td style="text-align:center;">
                    <asp:LinkButton ID="btCompleta" runat="server" ForeColor="White"><div id="infobar" style="background-color:#70db10; text-align:center; padding:5px; padding:5px; color:White; font-weight:bold; font-size:12pt;">DETTAGLI ORDINE</div></asp:LinkButton>
                </td>
            </tr>
        </table>
    </td>
...
<asp:Panel ID="Panel_Unico" Width="675px" runat="server">   
    ...
    <asp:Panel ID="pSpedizione" runat="server" Width="100%" Visible="true" style="overflow:hidden;">
        ...
        <asp:GridView ID="gvVettori" runat="server" AutoGenerateColumns="False" CellPadding="1" DataSourceID="sdsVettori" Font-Size="8pt" GridLines="None" Width="100%" DataKeyNames="id" ShowHeader="False">
            ...
            <Columns>
                ...
                <asp:TemplateField InsertVisible="False" ShowHeader="False">
                     <ItemTemplate>
                        <img src='<%# "Public/Vettori/" & Eval("Img") %>' title='<%# Eval("Informazioni") %>' alt="" />
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <tr>
        <td colspan="2">
            <div id="infobar" style="width:100%; color:White; font-weight:bold; height:50px; background-image:url('Public/Images/StepCarrello2.png'); background-size:100%; background-repeat:no-repeat;"></div>
        </td>
    </tr>
    
    <tr style="border-bottom:">
    <td valign="top" style="width: 50%">
        <asp:Panel ID="pAssicurazione" runat="server" Width="100%"  Visible="true" style="overflow:hidden;" >
            <table cellpadding="1" width="100%">
                <tr>
                    <td><asp:CheckBox ID="cbAssicurazione" runat="server" AutoPostBack="True" /></td>
                    <td width="100%">Assicurazione merce (escluso IVA)</td>
  ...
  <asp:Panel ID="pPagamento" runat="server" Width="99.5%" Visible="true">
        <asp:SqlDataSource ID="sdsPagamento" runat="server" ConnectionString="<%$ ConnectionStrings:EntropicConnectionString %>"
            ProviderName="<%$ ConnectionStrings:EntropicConnectionString.ProviderName %>"
            SelectCommand="SELECT distinct id, Descrizione, Informazioni, Predefinito, CostoPercentuale, CostoFisso, Contrassegno,img FROM vpagamentitipo WHERE Abilitato=1 AND CostoMassimo >= ?CostoMassimo AND (Web=1 OR UtenteID=?UtenteID) AND AziendeID=?AziendaID ORDER BY Ordinamento, Descrizione">
           <SelectParameters>
        ...
        Font-Size="8pt" GridLines="None" Width="100%" ShowHeader="False" DataKeyNames="id">
            <Columns>
                ...
                <asp:TemplateField>
                <ItemTemplate>
                    <img src='<%# "Public/Pagamenti/" & Eval("Img") %>' title='<%# Eval("Informazioni") %>' alt="" />
                </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="id" InsertVisible="False" SortExpression="id" Visible="False">
                    <EditItemTemplate>
...
<br />
    ...
    <td colspan="2">
    <asp:Panel ID="Panel2" runat="server" Width="100%" Visible="true" style="overflow:hidden;" >
        <div id="infobar" style="width:100%; color:White; font-weight:bold; height:50px; background-image:url('Public/Images/StepCarrello3.png'); background-size:100%; background-repeat:no-repeat;"></div>
        <table cellspacing="5" border="0" style="border-bottom-style:solid;" width="100%">
            
            <tr>
                <td><b>Ragione Sociale / Cognome:&nbsp;</b><asp:Label runat="server" ID="lblTab_RagioneSociale"></asp:Label></td>
                <td colspan="2"><b>Nome:&nbsp;</b><asp:Label runat="server" ID="lblTab_Nome"></asp:Label></td>
            </tr>    
            <tr>
                <td><b>P. IVA:&nbsp;</b><asp:Label runat="server" ID="lblTab_pIva"></asp:Label></td>
                <td colspan="2"><b>Codice fiscale:&nbsp;</b><asp:Label runat="server" ID="lblTab_CF"></asp:Label></td>
            </tr> 
            <tr>
                <td><b>Indirizzo:&nbsp;</b><asp:Label runat="server" ID="lblTab_Indirizzo"></asp:Label></td>
                <td><b>CAP:&nbsp;</b><asp:Label runat="server" ID="lblTab_Cap"></asp:Label></td>
                <td><b>Città:&nbsp;</b><asp:Label runat="server" ID="lblTab_Citta"></asp:Label></td>
            </tr>
            <tr>
                <td><b>Provincia:&nbsp;</b><asp:Label runat="server" ID="lblTab_Provincia"></asp:Label></td>
                <td><b>Telefono:&nbsp;</b><asp:Label runat="server" ID="lblTab_Tel"></asp:Label></td>
                <td><b>Cellulare:&nbsp;</b><asp:Label runat="server" ID="lblTab_Cell"></asp:Label></td>
            </tr> 
            <tr>
                <td><b>Fax:&nbsp;</b><asp:Label runat="server" ID="lblTab_Fax"></asp:Label></td>
                <td colspan="2"><b>E-mail:&nbsp;</b><asp:Label runat="server" ID="lblTab_mail"></asp:Label></td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td colspan="3" align="right"><a href="registrazione.aspx">I tuoi dati sono 
                errati? Clicca Qui per modificarli</a></td></tr>
        </table>
        </asp:Panel>
    </td>
    </tr>
        
    <!-- INSERISCI UNA NOTA / DESTINAZIONE ALTERNATIVA -->
    <tr>
        <td colspan="2" align="center">
         <asp:Panel ID="Panel_Opzioni" runat="server" Width="100%">
           <table style="text-align:center;" width="100%">
           <tr>
                <td style="width: 33%">
                    <asp:ImageButton ID="ImageButton_DestinazioneAlternativa" runat="server" ImageUrl="Public/Images/destinazione_alternativa.gif" />
                </td>
                <td style="width: 33%;">
                    <asp:ImageButton ID="ImageButton_InserisciNota" runat="server" ImageUrl="Public/Images/nota.gif" />
                </td>
                <td>
                    <asp:ImageButton ID="btSalvaPreventivo" runat="server" ImageUrl="Public/Images/salva_preventivo.gif" OnClientClick="javascript:visualizza_spinner_caricamento();" />
                </td>
           </tr>
           </table>
        </asp:Panel>
    ...
    <tr>
        <td colspan="3">
            <asp:Panel ID="PnlDestinazione" runat="server" Width="100%" Visible="False" GroupingText="Destinazione Alternativa / Servizio Drop-Ship " >
                <asp:Label ID="LblDescrDest" runat="server" Text=""></asp:Label>
                <br />
                Seleziona tua destinazione alternativa:<br />
                <asp:DropDownList runat="server" ID="LstDestinazione" AutoPostBack="True"></asp:DropDownList>
                <br />
                <br />
                Se l'indirizzo non è presente nella lista delle destinazioni oppure vuoi 
                modificarne uno esistente:<br />
                <table id="tblDestAlter" cellpadding="1" cellspacing="5" border="0" width="500px" runat="server" style="margin:auto;">
                    <tr>
                        <td bgcolor="whitesmoke" width="200px">&nbsp;Cognome o Ragione Sociale</td>
                        <td ><asp:TextBox ID="tbRagioneSocialeA" runat="server" Width="200" MaxLength="100" ValidationGroup="registrazione" CausesValidation="True"></asp:TextBox>
                            <asp:TextBox ID="tbRagioneSocialeAId" runat="server" Width="20" Visible="False" ></asp:TextBox>
                    ...
                    <tr>
                        <td bgcolor="whitesmoke" width="200px">&nbsp;Nome</td>
                        <td ><asp:TextBox ID="tbNomeA" runat="server" Width="200" MaxLength="50" ValidationGroup="registrazione" CausesValidation="True"></asp:TextBox><asp:TextBox ID="tbNomaAid" runat="server" Width="20" Visible="False" ></asp:TextBox>
                             <asp:requiredfieldvalidator id="RFNomeA" runat="server" Display="None" ControlToValidate="tbNomeA"
		                       ErrorMessage="Campo Obbligatorio (Nome)"></asp:requiredfieldvalidator>    
                        </td>
                    </tr>        
                    <tr>
                        <td bgcolor="whitesmoke" width="200px">&nbsp;Indirizzo</td>
                        <td ><asp:TextBox ID="tbIndirizzo2" runat="server" Width="200" MaxLength="100" ValidationGroup="registrazione" CausesValidation="True"></asp:TextBox><asp:TextBox ID="tbIndirizzoId" runat="server" Width="20" Visible="False" ></asp:TextBox>
                    ...
                    <tr>
                        <td bgcolor="whitesmoke" width="200px">&nbsp;Città </td>
                        <td ><asp:TextBox ID="tbCitta2" runat="server" Width="200" MaxLength="100" ValidationGroup="registrazione" CausesValidation="True"></asp:TextBox>
                             <asp:requiredfieldvalidator id="RFCitta2" runat="server" Display="None" ControlToValidate="tbCitta2"
		                       ErrorMessage="Campo Obbligatorio (Città)"></asp:requiredfieldvalidator>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="whitesmoke" width="200px">&nbsp;Provincia </td>
                        <td ><asp:TextBox ID="tbProvincia2" runat="server" Width="200" MaxLength="20" ValidationGroup="registrazione" CausesValidation="True"></asp:TextBox>
                    ...
                    <tr>
                        <td bgcolor="whitesmoke" width="200px">&nbsp;Cap </td>
                        <td ><asp:TextBox ID="tbCap2" runat="server" Width="200" MaxLength="5" ValidationGroup="registrazione" CausesValidation="True"></asp:TextBox>
                    ...
                    <tr>
                        <td bgcolor="whitesmoke" width="200px">&nbsp;Zona</td>
                        <td ><asp:TextBox ID="tbZona" runat="server" Width="200" MaxLength="100" ValidationGroup="registrazione" CausesValidation="True"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="whitesmoke" width="200px" valign="top">&nbsp;Note</td>
                        <td ><asp:TextBox ID="tbNote" runat="server" Width="200" MaxLength="255" ValidationGroup="registrazione" CausesValidation="True" TextMode="MultiLine" Rows="5"></asp:TextBox>
                        </td>
                    </tr>  
                    <tr><td><asp:CheckBox runat="server" ID="CHKPREDEFINITO" Text="Indirizzo predefinito" Checked="false" /><br /></td></tr> 
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Button ID="btnSalvaDest" runat="server" Text="IINSERISCI come NUOVA destinazione" Height="25px" CausesValidation="true" />
                            ...
                            <br /><br /><asp:Button ID="btnAnnullaDest" runat="server" Text="ANNULLA Destinazione Alternativa" Height="25px" CausesValidation="false" />
                        </td>
                    </tr>
    ...
    <tr><td colspan="3"><asp:Panel ID="Panel_Note" runat="server" Width="100%" Visible="False" GroupingText="Note" >
        Note: &nbsp; <asp:TextBox ID="txtNoteSpedizione" TextMode="MultiLine" Rows="3" runat="server" Width="50%"></asp:TextBox></asp:Panel>
    </td></tr>
   ...
   <tr>
        <td style=" border-bottom-style:solid; border-bottom-width:1px; border-bottom-color:Gray; padding-bottom:10px;">
            <asp:LinkButton ID="btInviaOrdine" runat="server" ForeColor="White" OnClientClick="javascript:visualizza_spinner_caricamento();"><div id="infobar" style="width:30%; background-color:#70db10; text-align:center; padding:5px; padding:5px; color:White; font-weight:bold; font-size:12pt; float:right;">CONFERMA ORDINE</div></asp:LinkButton>
        </td>
   </tr>
   <tr>
        <td style="text-align:center;">
...
<asp:validationsummary id="ValidationSummary1" runat="server" HeaderText="Attenzione!" ShowMessageBox="True" ShowSummary="False"></asp:validationsummary>
    ...
    <!-- Tooltip -->
    <script type="text/javascript">
        JQ("#promo_vettori img[title]").tooltip({position: "center right"});
        JQ("#gvVettori_tooltip img[title]").tooltip({position: "center right"});
        JQ("#gvPagamento_tooltip img[title]").tooltip({position: "center right"});
    </script>
