...
<td align="right" valign="top" style="line-height: 135%;font-size:8pt; width: 57%;">
    Buono Sconto IVA:</td>
<td align="right" width="50%" valign="top" style="font-size:9pt"><asp:Label ID="lblBuonoScontoIVA" runat="server" Text="&#8364; 0,00" Font-Bold="true"></asp:Label></td>
</tr>
<tr>
...
<asp:Panel ID="Panel_Unico" Width="675px" runat="server">   
    ...
    <asp:Panel ID="pSpedizione" runat="server" Width="100%" Visible="true" style="overflow:hidden;">
		...
		<div style="width:100%; color:White; font-weight:bold; height:50px;">
			<div id="infobar" style="width:5%; font-size:40px; height:100%; float:left;background-image:none;">1</div>
			<div style="width:95%; height:100%; float:left;">
				<div style="width:100%; height:25%;"></div>
				<div style="width:100%; height:50%;">
					<div id="infobar" style="width:10%; height:100%; float:left; background-image:none;line-height: 200%; vertical-align: middle;">STEP di 4</div>
					<div id="infobar" style="width:90%; height:100%; float:left; background-image:none;line-height: 200%; vertical-align: middle;">SPEDIZIONE</div>
				</div>
				<div style="width:100%; height:25%;"></div>
			</div>
		</div>
    ...
    <tr>
        <td colspan="2">
			<div style="width:100%; color:White; font-weight:bold; height:50px;">
				<div id="infobar" style="width:5%; font-size:40px; height:100%; float:left;background-image:none;">2</div>
				<div style="width:95%; height:100%; float:left;">
					<div style="width:100%; height:25%;"></div>
					<div style="width:100%; height:50%;">
						<div id="infobar" style="width:10%; height:100%; float:left; background-image:none;line-height: 200%; vertical-align: middle;">STEP di 4</div>
						<div id="infobar" style="width:90%; height:100%; float:left; background-image:none;line-height: 200%; vertical-align: middle;">ASSICURAZIONE E PAGAMENTO</div>
					</div>
					<div style="width:100%; height:25%;"></div>
				</div>
			</div>
...
<br />
    ...
    <asp:Panel ID="PnlFatturazione" runat="server" Width="100%" Visible="true" style="overflow:hidden;" >
        <div style="width:100%; color:White; font-weight:bold; height:50px;">
			<div id="infobar" style="width:5%; font-size:40px; height:100%; float:left;background-image:none;">3</div>
			<div style="width:95%; height:100%; float:left;">
				<div style="width:100%; height:25%;"></div>
				<div style="width:100%; height:50%;">
					<div id="infobar" style="width:10%; height:100%; float:left; background-image:none;line-height: 200%; vertical-align: middle;">STEP di 4</div>
					<div id="infobar" style="width:90%; height:100%; float:left; background-image:none;line-height: 200%; vertical-align: middle;">DATI FATTURAZIONE</div>
				</div>
				<div style="width:100%; height:25%;"></div>
			</div>
		</div>
        <table cellspacing="5" border="0" style="border-bottom-style:solid;" width="100%">
			...
			<tr>
                <td><b>Nome:&nbsp;</b><asp:Label runat="server" ID="lblTab_Nome"></asp:Label></td>
            </tr>  
            <tr>
                <td><b>P. IVA:&nbsp;</b><asp:Label runat="server" ID="lblTab_pIva"></asp:Label></td>
            </tr> 
			<tr>
                <td><b>Codice fiscale:&nbsp;</b><asp:Label runat="server" ID="lblTab_CF"></asp:Label></td>
            </tr> 
            <tr>
            ...
            <tr>
                <td><b>E-mail:&nbsp;</b><asp:Label runat="server" ID="lblTab_mail"></asp:Label></td>
            </tr>
            <tr>
				<td>&nbsp;</td>
			</tr>
                ...
                <table id="tblDestAlter" cellpadding="1" cellspacing="5" border="0" width="500px" runat="server" style="margin:auto;">
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Button ID="btnSalvaDest" runat="server" Text="INSERISCI come NUOVA destinazione" Height="25px" CausesValidation="true" />
